...
export const isMessagePinned = (
  msg?: Pick<V2NIMMessageForUI, "pinState">
) => {
  return (
    msg?.pinState ===
      V2NIMConst.V2NIMMessagePinState.V2NIM_MESSAGE_PIN_STATE_PINNED ||
    !!msg?.pinState
  );
};

export const getMessageRefer = (
...
export const getPinOperatorId = (
  msg: V2NIMMessageForUI,
  pinInfoMap?: Map<string, any> | null
) => {

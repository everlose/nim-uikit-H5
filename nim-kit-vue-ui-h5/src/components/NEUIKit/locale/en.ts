...
export default {
  ...
  getMergedForwardMsgFailedText: "Failed to get message",
  deleteText: "Delete",
  ...
  mergedForwardText: "Merged forward",
  oneByOneForwardLimitText: "One by one forward is limited to 10 messages",
  mergedForwardLimitText: "Merged forward is limited to 100 messages",
  forwardMultiSelectLimitText: "You can only select up to 9 conversations",
  forwardExceptionTitle: "Exception details",
  forwardExceptionContent:
    "Some messages can't be forwarded. Remove them before retry",

...
var ConnectStore = /** @class */ (function () {
    ...
    ConnectStore.prototype._onDataSync = function (e) {
        var _a, _b, _c, _d;
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log('_onDataSync', e);
        // 同步后需先清理下上次的状态
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        error_4 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('acceptAddApplicationActive failed: ', application, error_4);
                        throw error_4;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        error_5 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('rejectFriendApplyActive failed: ', application, postscript, error_5);
                        throw error_5;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        error_7 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('setFriendInfoActive failed: ', accountId, params, error_7);
                        throw error_7;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_h) {
                switch (_h.label) {
                    ...
                    case 1:
                        _h.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, ((_c = (_b = this.localOptions).sendMsgBefore) === null || _c === void 0 ? void 0 : _c.call(_b, params))];
                    case 2:
                        ...
                        (_e = this.logger) === null || _e === void 0 ? void 0 : _e.log('sendMessageActive finalParams: ', newMsg, conversationId, finalParams);
                        return [4 /*yield*/, this.nim.V2NIMMessageService.sendMessage(newMsg, conversationId, finalParams, function (percentage) {
                    ...
                    case 4:
                        error_3 = _h.sent();
                        (_g = this.logger) === null || _g === void 0 ? void 0 : _g.error('sendMessageActive failed: ', error_3.toString(), newMsg);
                        // 手动取消上传
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        error_4 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('cancelMessageAttachmentUploadActive failed: ', msg, error_4);
                        throw error_4;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        error_5 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('sendMsgReceiptActive failed: ', msg, error_5.toString());
                        throw error_5;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        error_6 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('addCollectionActive failed: ', params, error_6.toString());
                        throw error_6;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        error_7 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('removeCollectionsActive failed: ', collections, error_7.toString());
                        throw error_7;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        error_8 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('getCollectionListByOptionActive failed: ', option, error_8.toString());
                        throw error_8;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 3:
                        error_9 = _e.sent();
                        (_d = this.logger) === null || _d === void 0 ? void 0 : _d.error('sendTeamMsgReceiptActive failed: ', msgs, error_9.toString());
                        throw error_9;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 2:
                        error_10 = _d.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('sendTeamMsgReceiptActive failed: ', message, memberAccountIds, error_10.toString());
                        throw error_10;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 4:
                        error_11 = _e.sent();
                        (_c = this.logger) === null || _c === void 0 ? void 0 : _c.error('getHistoryMsgActive failed: ', options, error_11.toString());
                        throw error_11;
                    case 5: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_13 = _c.sent();
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.warn('getTeamMsgReadsActive failed but continue: ', error_13.toString());
                        return [3 /*break*/, 4];
                    case 4:
                        newMsgs = msgs
                            .filter(function (msg) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_14 = _c.sent();
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.warn('pinMessageActive failed but continue: ', error_14.toString());
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_15 = _c.sent();
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.warn('uppinMessageActive failed but continue: ', error_15.toString());
                        // 这里需要把错误抛出去，让 ui 层感知到
                        throw error_15;
                    case 4: return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_16 = _c.sent();
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.warn('updatePinMessageActive failed but continue: ', error_16.toString());
                        // 这里需要把错误抛出去，让 ui 层感知到
                        throw error_16;
                    case 4: return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_17 = _c.sent();
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.error('stopAIStreamMessageActive failed ', error_17.toString());
                        throw error_17;
                    case 4: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_18 = _c.sent();
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.error('regenAIMessageActive failed ', error_18.toString());
                        throw error_18;
                    case 4: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_19 = _c.sent();
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.warn('voiceToTextActive failed: ', error_19.toString());
                        // 这里需要把错误抛出去，让 ui 层感知到
                        throw error_19;
                    case 4: return [2 /*return*/];
                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        error_20 = _b.sent();
                        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.warn('_getMessageListByRefer failed but continue: ', error_20.toString());
                        return [3 /*break*/, 4];
                    case 4: return [2 /*return*/, res];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        error_21 = _c.sent();
                        (_b = this.logger) === null || _b === void 0 ? void 0 : _b.warn('_getPinnedMessageListByServer failed but continue: ', error_21.toString());
                        return [3 /*break*/, 4];
                    case 4:
...
var TeamStore = /** @class */ (function () {
    ...
    TeamStore.prototype.createTeamActive = function (_a) {
        var _b, _c, _d;
        var accounts = _a.accounts, _e = _a.type, type = _e === void 0 ? 1 /* V2NIMConst.V2NIMTeamType.V2NIM_TEAM_TYPE_ADVANCED */ : _e, avatar = _a.avatar, name = _a.name, intro = _a.intro, serverExtension = _a.serverExtension;
        return __awaiter(this, void 0, void 0, function () {
            var team, error_1;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        error_1 = _f.sent();
                        (_d = this.logger) === null || _d === void 0 ? void 0 : _d.error('createTeamActive failed: ', { accounts: accounts, avatar: avatar, name: name }, error_1, error_1.code, error_1.detail);
                        throw error_1;
                    case 3: return [2 /*return*/];
                }
            });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 2, , 3]);
                        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log('passTeamApplyActive: ', options);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 2, , 3]);
                        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.log('getUserListForceActive', accountId);
...
export { AIUserStore, ConnectStore, ConversationStore, FriendStore, LocalConversationStore, MsgStore, RelationStore, RootStore, StorageStore, SysMsgStore, TeamMemberStore, TeamStore, UiStore, UserStore, RootStore as default, constant as storeConstants, utils as storeUtils };

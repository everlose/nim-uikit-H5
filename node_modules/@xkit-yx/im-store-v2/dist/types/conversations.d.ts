...
import { V2NIMConversationResult, V2NIMConversationType } from 'nim-web-sdk-ng/dist/esm/nim/src/V2NIMConversationService';
import { V2NIMMessage, V2NIMP2PMessageReadReceipt } from 'nim-web-sdk-ng/dist/esm/nim/src/V2NIMMessageService';
import { V2NIMConversationForUI } from './types';
import * as storeUtils from './utils';
/**Mobx 可观察对象，负责管理会话列表的子 store */
export declare class ConversationStore {
    private rootStore;
    private nim;
    conversations: Map<string, V2NIMConversationForUI>;
     ...
     * @param limit 分页拉取数量
     */
    getConversationListActive(offset: number, limit: number): Promise<V2NIMConversationResult>;
